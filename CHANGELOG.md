...
- Expanded the Linear CLI with team/user, project, milestone, document, and issue-comment commands; cursor pagination; safe browser/app and GitHub PR integrations; destructive-operation dry runs and confirmations.
...
- Initial issue-focused Linear CLI: repository configuration, team listing, issue reads, create/update, and Git-first start workflow.
